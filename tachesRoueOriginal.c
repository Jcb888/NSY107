...
/**************************************/
 {
  ...
  float blocCapteurs[10*4];
  int i;

  /* simulation de l'envoi de 10 échantillons constants */
  ...
  for (i=0; i<10; i++ )
    ...
    ecrireTableauReels('S',blocCapteurs,10*4);
...
void DisplayInfoTask(void)
{
    ...
    else rt_printf("Erreur de lecture de l etat de la tache (numero %d )\n",cr);
                         ...
                         case TYPE_CAR :
                                  {
                            		...
                            		case 'D':  /* debut experimentation */
                            		{
                                      ...
                                      case 'C':  /* lecture valeurs courantes capteurs */
                                      {
...
int main( int argc, char* argv[])
{
   ...
   /* initialisation du gestionnaire de signal pour arrêt de l'application par cntl-c */
...
/* initialisation de la carte d'entrees-sorties analogiques */
  printf("-------- Demarrage appli temps réel------ \n");
...
/* creation des semaphores pour la synchro  */
/* ------------------------------------ */
...
/* destruction des files et des semaphores */
/*------------------------*/
