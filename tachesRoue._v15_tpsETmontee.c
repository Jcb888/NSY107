...
rev 15 mesure des timings et essais iconsigne
			...
			rt_printf("valeur switch loi : %d \n", parametresExperimentation.loi);
				...
				case 0 :{//Boucle ouverte
					...
					if (parametresExperimentation.profilConsigne == 0){//echelon
						...
						rt_printf("valeur type loi : %d profilConsigne:%d valeur cde: %f \n", parametresExperimentation.loi, parametresExperimentation.profilConsigne, cde);
				...
				case 11 :{ //Loi 1 Boucle position voir cahier des charges page 8 ?? consigne en Radian --> ?? conversion en amperes ??
